package sodiumpublickeyboxxchacha20poly1305
...
func GetSeedBytesLength() int {
	return int(C.crypto_box_curve25519xchacha20poly1305_seedbytes())
}

func GetPublicKeyBytesLength() int {
	return int(C.crypto_box_curve25519xchacha20poly1305_publickeybytes())
}

func GetSecretKeyBytesLength() int {
	return int(C.crypto_box_curve25519xchacha20poly1305_secretkeybytes())
}

func GetNonceBytesLength() int {
	return int(C.crypto_box_curve25519xchacha20poly1305_noncebytes())
}

func GetMACBytesLength() int {
	return int(C.crypto_box_curve25519xchacha20poly1305_macbytes())
}

func GetMaxMessageBytesLength() int64 {
	return int64(C.crypto_box_curve25519xchacha20poly1305_messagebytes_max())
}
...
func Create(
	...
	ret := C.crypto_box_curve25519xchacha20poly1305_easy(
...
func PublicKeyBoxOpen(
	...
	ret := C.crypto_box_curve25519xchacha20poly1305_open_easy(
		(*C.uchar)(unsafe.Pointer(&message[0])),
...
func PublicKeyBoxCreateDetached(
	...
	ret := C.crypto_box_curve25519xchacha20poly1305_detached(
		(*C.uchar)(unsafe.Pointer(&cipherText[0])),
...
func PublicKeyBoxOpenDetached(
	...
	ret := C.crypto_box_curve25519xchacha20poly1305_open_detached(
		(*C.uchar)(unsafe.Pointer(&message[0])),
		(*C.uchar)(unsafe.Pointer(&cipherText[0])),
		(*C.uchar)(unsafe.Pointer(&mac[0])),
		C.ulonglong(len(cipherText)),
